...
- (void)saveSleep:(NSDate *)startDate end:(NSDate *)endDate {
    
//    HKUnit *sleepStart = [HKUnit hourUnit];
    
//    HKCategoryTypeIdentifierSleepAnalysis
//    @abstract      Set of values that may be used for HKCategorySamples with the HKCategoryTypeIdentifierSleepAnalysis type.

    HKCategoryType *catt = [HKCategoryType categoryTypeForIdentifier: HKCategoryTypeIdentifierSleepAnalysis];
    
//    HKCategorySample *catSamp = [HKCategorySample categorySampleWithType:catt value:3 startDate:[NSDate date] endDate:[NSDate date]];

//    [self.healthStore saveObject:catSamp withCompletion:^(BOOL success, NSError *error) {
//        
//        if (success) {
//            NSLog(@"save cat");
//        }
